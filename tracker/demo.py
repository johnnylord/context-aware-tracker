...
from track.demo import DemoTrack
...
class DemoTracker(MSVTracker):
    ...
    def __next__(self):
        ...
        for pair in match_pairs:
            track = pair[0]
            bbox, keypoints, feature = pair[1][:4], pair[1][5:5+75], pair[1][5+75:]
            track.update_head(keypoints.reshape(25, -1))
        ...
        for observation in observations:
            bbox = observation[:4]
            feature = observation[5+75:]
            track = DemoTrack(bbox=bbox, feature=feature, id=self.counter)
